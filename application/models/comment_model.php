...
class Comment_model extends CI_Model {
    function __construct() {
        ...
        $this->field = array( 'id', 'post_id', 'email', 'fullname', 'comment', 'comment_time', 'is_publish' );
    }
    ...
    function get_array($param = array()) {
		...
		$string_post = (!empty($param['post_id'])) ? "AND Comment.post_id = '".$param['post_id']."'" : '';
		$string_namelike = (!empty($param['namelike'])) ? "AND Comment.comment LIKE '%".$param['namelike']."%'" : '';
		$string_filter = GetStringFilter($param, @$param['column']);
		$string_sorting = GetStringSorting($param, @$param['column'], 'comment_time DESC');
